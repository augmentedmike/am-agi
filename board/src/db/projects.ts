...
export function updateProject(db: Db, id: string, input: { name?: string; repoDir?: string; isTest?: boolean; githubRepo?: string; vercelUrl?: string; currentVersion?: string; templateType?: string; defaultBranch?: string }) {
