        ...
        <div className="px-5 py-4 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-end gap-2 pt-1">
            ...
            <button
              ...
              onClick={onConfirm}
              disabled={submitting}
              className="px-4 py-2 text-sm font-medium bg-action-danger hover:bg-action-danger-hover disabled:opacity-50 text-white rounded-lg transition-colors flex items-center gap-2"
            >
              {submitting && (
