...
export const en = {
  ...
  amBoard: 'AM',
  amTagline: 'Your persistent digital worker — context, tasks, and shipping, all in one place.',
  ...
  templateCustomerSuccessName: 'Customer Success',
  templateCustomerSuccessDesc: 'Account health from onboarding to renewal',
  templateHiringName: 'Hiring Pipeline',
  templateHiringDesc: 'Recruiting pipeline from source to hire',
  templatePartnershipsName: 'Partnerships',
  templatePartnershipsDesc: 'BizDev pipeline from target to active partner',
  templatePrOutreachName: 'PR Outreach',
  templatePrOutreachDesc: 'Media outreach from story angle to coverage',
  templateKnowledgeBaseName: 'Knowledge Base',
  templateKnowledgeBaseDesc: 'Docs pipeline from gap to published and maintained',
  templateCommunityName: 'Community',
  templateCommunityDesc: 'Engagement pipeline from signal to resolved',
  templateOpsName: 'Operations',
  templateOpsDesc: 'Ops orchestration from request intake to done',
