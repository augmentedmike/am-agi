    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 shrink-0">
          <span className="text-sm font-semibold uppercase tracking-wide text-zinc-400">Stats</span>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-zinc-800/60 border border-white/5 rounded-xl px-4 py-4">
              <p className="text-xs text-zinc-500 uppercase tracking-wide font-semibold mb-1">Total</p>
          ...
          {/* Per-column counts */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-wide text-zinc-500 mb-3">By Column</h3>
          ...
          {/* SVG bar chart */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-wide text-zinc-500 mb-4">Distribution</h3>
            <svg
                ...
                return (
                  <g key={state}>
                    ...
                    <text
                      ...
                      fontWeight="500"
                    >
                      {state === 'in-progress' ? 'WIP' : state === 'in-review' ? 'Review' : STATE_LABELS[state]}
                    </text>
                  </g>
                );
              })}
