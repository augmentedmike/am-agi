...
| File | Summary |
|---|---|
| [AGENT-LOOP.MD](docs/AGENT-LOOP.MD) | The wiggum loop — one-shot agentic iteration pattern with pre/post git hooks, worktree isolation, and a linear merge strategy |
